        ...
        <form action="InfoServlet" method="post">
            ...
            <div class="forms">
                ...
                <div class="col-md-4">
                    <!--输入传染率-->
                    <div class="form-group">
                        <label for="keyword">输入对疫情知情者的感染率与对不知情者感染率的比值</label>
                       <input id="keyword" type="text" placeholder="输入比值(如 0.5)" class="form-control" name="p"/>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                 ...
                 <div class="col-md-4">
                   ...
                   <div class="col-md-4">
                    <!--输入传染率-->
                    <div class="form-group">
                        <label for="keyword">输入第一阶段对疫情知情的人数占总人数的比例</label>
                       <input id="keyword" type="text" placeholder="输入比例(如 0.5)" class="form-control" name="j"/>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <!--输入传染率-->
                    <div class="form-group">
                        <label for="keyword">输入第二阶段对疫情知情的人数占总人数的比例</label>
                       <input id="keyword" type="text" placeholder="输入倍数(如 0.5)" class="form-control" name="k"/>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <!--输入传染率-->
                    <div class="form-group">
                        <label for="keyword">输入第三阶段对疫情知情的人数占总人数的比例</label>
                       <input id="keyword" type="text" placeholder="输入倍数(如 0.5)" class="form-control" name="m"/>
                    </div>
                </div>
