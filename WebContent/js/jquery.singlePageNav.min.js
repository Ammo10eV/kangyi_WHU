...
if(typeof Object.create!=="function"){
    ...
    "use strict";var i={
        init:function(n,r){
            ...
            },e.fn.singlePageNav.defaults,n);this.container=r;this.$container=e(r);this.$links=this.$container.find("a");if(this.options.filter!==""){
            ...
            var n=this,r=t.currentTarget,i=e(r.hash);t.preventDefault();if(i.length){
            ...
            var n=this;var r=n.getCoords(e).top;var i=false;n.$htmlbody.stop().animate({
                scrollTop:r
            },{
