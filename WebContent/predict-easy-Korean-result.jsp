            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6" style="text-align: center; box-shadow: 1px 1px 4px rgba(3,3,19,0.25);">
                        ...
                        <div class="btn-group btn-group-justified" role="group" style="margin-bottom: 5px;">
                            <div class="btn-group" role="group">
                                <a href="predict-easy.html">
                                    <button type="button" class="btn btn-default">中国</button>
                                </a>
                            </div>
                            <div class="btn-group" role="group">
                                <a href="predict-easy-Korean.html">
                                    <button type="button" class="btn btn-primary">韩国</button>
                                </a>
                            </div>
                            <div class="btn-group" role="group">
                                <a href="predict-easy-Italy.html">
                    ...
                    <div class="col-md-2" style="text-align: center; box-shadow: 1px 1px 4px rgba(3,3,19,0.25);">
                        ...
                        <div class="btn-group btn-group-justified" role="group" style="margin-bottom: 5px;">
                            <div class="btn-group" role="group">
                                <a href="predict-easy-Spain.html">
            ...
            <div class="container" style="margin-top: 10px">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2 fill" style="margin-left: 15px">
                        <h4 style="color: darkred">4737861</h4>
                        <h3>累计确诊</h3>
                        <p>较昨日：<span style="color: darkred">+72434</span></p>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div style="margin-top: 80px; text-align: center; border-width:1px; border-style: solid; border-radius:5px;border-color: black;">
                            <p style="margin:5px;">预测确诊人数顶峰在:<br>第75天</p>
                            <p style="margin:5px;">预测最多确诊人数为:<br>2186533人</p>
                        </div>
                        <div style="margin-top: 50px; text-align: center; border-width:1px; border-style: solid; border-radius:5px;border-color: black;">
                            <p style="margin:5px;">预测无症状患者数顶峰在:<br>第75天</p>
                            <p style="margin:5px;">预测最多无症状患者数为:<br>4004158人</p>
                        </div>
                    </div>
                    <div class="col-md-1"></div>
                </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <form action="EasymodelServlet" method="post" >
                            <div class="form-inline">
								...
								<input type="hidden" name="pagename" value="Korean" >
